...
public class AlphaBetaPlayer implements Player{
	...
	public void playBestMove(){
		...
		//Find the best move
		Move m = getMaxMove(this.g.getGameState(), Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, null);
	...
	private Move getMaxMove(GameState gState, double alpha, double beta, Move lastMove_Player1){
		...
		if(this.g.isGameOver(gState, false) || this.depthCount == this.g.getDepthLimit()){
			...
			//System.out.println("The number of p2 valid moves is: " + p2ValidMoves.size());
			...
			for (Move m: p2ValidMoves){
				...
				Move m2 = getMinMove(newState, alpha, beta, m);
				
				System.out.println("The depth is now " + this.depthCount);
	...
	private Move getMinMove(GameState gState, double alpha, double beta, Move lastMove_Player2){
		...
		if(this.g.isGameOver(gState, false) || this.depthCount == this.g.getDepthLimit()){
			...
			for (Move m: p1ValidMoves){
				...
				Move m2 = getMaxMove(newState, alpha, beta, m);
